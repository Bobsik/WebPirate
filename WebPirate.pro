...
opendesktopfile.files = harbour-webpirate-open-url.desktop
opendesktopfile.path = /usr/share/harbour-webpirate

# Install D-Bus Service (Currently Disabled)
dbus.files = org.harbour.webpirate.service
dbus.path = /usr/share/harbour-webpirate
